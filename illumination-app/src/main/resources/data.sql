-- address_data
INSERT INTO mkaldus1.address_data (address_data_description, address_data_name, city, country, latitude, longitude, street)
...
-- lamp_module_data
INSERT INTO mkaldus1.lamp_module_data (lamp_module_description, lamp_module_name, ip_address, port)
        VALUES ('Dary moduł', 'DareModule', '127.0.0.1', 8081);
INSERT INTO mkaldus1.lamp_module_data (lamp_module_description, lamp_module_name, ip_address, port)
        VALUES ('Moduł Reymonta', 'ReymontaModule', '127.0.0.1', 8081);

-- light_lamp_data
INSERT INTO mkaldus1.light_lamp_data (light_lamp_description, light_lamp_name, status, address_data_id, lamp_module_number, light_lamp_module_id)
...
-- role
INSERT INTO mkaldus1.role (role_name) VALUES ('USER');
INSERT INTO mkaldus1.role (role_name) VALUES ('ADMIN');

-- user
INSERT INTO mkaldus1.user (usr_login, usr_password)
...
-- user_role
INSERT INTO mkaldus1.user_role (ur_usr_id, ur_role_id) VALUES (1, 2);
INSERT INTO mkaldus1.user_role (ur_usr_id, ur_role_id) VALUES (1, 1);
INSERT INTO mkaldus1.user_role (ur_usr_id, ur_role_id) VALUES (2, 1);
INSERT INTO mkaldus1.user_role (ur_usr_id, ur_role_id) VALUES (2, 2);